...
function CarouselItem({
  ...
  const animatedStyle = useAnimatedStyle(() => {
    ...
    // Cover-flow 3D effect based on scroll position instead of pan gesture
    const rotateY = interpolate(diff, [-SNAP_INTERVAL, 0, SNAP_INTERVAL], [-15, 0, 15], Extrapolation.CLAMP)
